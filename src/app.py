...
app.config['MONGO_URI']='mongodb+srv://PabloDavid:Avengers16@recuperacion.ekfuboc.mongodb.net/?retryWrites=true&w=majority'
client = MongoClient("mongodb+srv://PabloDavid:Avengers16@recuperacion.ekfuboc.mongodb.net/?retryWrites=true&w=majority")
